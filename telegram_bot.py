        ...
        try:
            ...
            if response.status_code == 200:
                ...
                def create_simple_message(signal_type, confidence, next_time, total_candles):
                    ...
                    simple_msg = (
                        f"GHOST TRANSCENDENCE CORE CANDLE WHISPERER\n\n"
                        f"SIGNAL: {clean_signal}\n"
                        f"TIMEFRAME: 1M\n"
                        f"ENTRY TIME: {clean_time} UTC 6\n"
                        f"CONFIDENCE: {clean_confidence} percent\n\n"
                        f"CANDLE CONVERSATIONS: {total_candles} candles consulted\n\n"
                        "FEATURES ACTIVE:\n"
                ...
                try:
                    ...
                    fallback_message = (
                        "CANDLE WHISPERER ANALYSIS COMPLETE\n\n"
                        f"Signal: {safe_signal}\n"
                        f"Entry: {safe_time} UTC 6\n"
                        f"Confidence: {safe_confidence} percent\n"
                        f"Candles: {safe_candles}\n\n"
                    ...
                    try:
                        ...
                        try:
                            ...
                            emergency_msg = (
                                f"SIGNAL {emergency_signal} "
                                f"TIME {emergency_time} "
                                f"CONFIDENCE {emergency_conf}"
                            )
